...
· [Архитектура](./docs/ru/architecture.md) · [API](./docs/ru/api.md) · [Механика аукционов](./docs/ru/auction-mechanics.md) · [Конкурентность](./docs/ru/concurrency.md) · [Тестирование](./docs/ru/testing.md) · [Деплой](./docs/ru/deployment.md)
...
┌─────────────────────────────────────────────────────────────────────┐
│  ОДИН ПРОЦЕСС                                                       │
│    HTTP:       2,779 req/sec пик, 197 req/s стандартная нагрузка    │
│    WebSocket:  200,018 emit/sec пик, 175,970/sec устойчивая         │
│    Латентность: 1.5мс mean, 5мс p99                                 │
│                                                                     │
│  КЛАСТЕРНЫЙ РЕЖИМ (12 ядер, sticky sessions)                        │
│    HTTP:       7,216 req/sec пик, 99.96% успех (+160%)              │
│    WebSocket:  251,640 emit/sec пик, 12M emits, 80% успех (+26%)    │
│                                                                     │
...
| **Ультра-быстрые ставки** | Единый Redis Lua скрипт (~1.4мс mean), WebSocket real-time обновления |
