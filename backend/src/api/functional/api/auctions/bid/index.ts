 ...
 * @module api.functional.api.auctions.bid
 ...
 * @path POST /api/auctions/:id/bid
 * @accessor api.functional.api.auctions.bid.placeBid
 * @nestia Generated by Nestia - https://github.com/samchon/nestia
 */
...
export namespace placeBid {
  ...
  export const path = (id: string) =>
    `/api/auctions/${encodeURIComponent(id?.toString() ?? "null")}/bid`;
