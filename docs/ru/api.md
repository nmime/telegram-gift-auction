...
Сделать ставку через высокопроизводительный Redis путь (~2мс латентность, 2,500+ ставок/сек).

Автоматически переключается на стандартный путь, если кэш не прогрет.
